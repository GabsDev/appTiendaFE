...
export class AuthenticationService {
  ...
  createUser(user: any): Observable<any> {
    ...
    return this.http.post<any>(this.ServerUrl + "product/auth/register", user);
  }

  //Login
  loginUser(user: any): Observable<any> {
    return this.http
      .post<any>(this.ServerUrl + "product/auth/login", user)
      .pipe(
        map((user) => {
  ...
  logout() {
    ...
    if (usuario) {
      ...
      return this.http.post<any>(this.ServerUrl + "product/auth/logout", {});
    }
  }
}
